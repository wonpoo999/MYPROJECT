...
import com.example.health_dietcare.service.FoodRecognitionService;
import com.example.health_dietcare.service.NutritionService;
    ...
    public Mono<FoodDtos.LogRes> upload(@RequestPart("file") FilePart file){
        ...
        return file.transferTo(tmp).then(Mono.fromCallable(() -> {
            ...
            if (!vision.isAcceptable(top)) {
                return new FoodDtos.LogRes(
                        "ambiguous", null, null, null, null, null, null,
